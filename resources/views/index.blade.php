<x-layouts.guest title="Search Jobs">
    <!-- Carousel Start -->
    <div class="p-0 container-fluid">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{ asset('/static/img/carousel-1.jpg') }}" alt="">
                <div class="top-0 position-absolute start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(43, 57, 64, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="mb-4 text-white display-3 animated slideInDown">Find The Perfect Job That You
                                    Deserved</h1>
                                <p class="pb-2 mb-4 text-white fs-5 fw-medium">Vero elitr justo clita lorem. Ipsum dolor
            ...
            <div class="owl-carousel-item position-relative">
                <img class="img-fluid" src="{{ asset('/static/img/carousel-2.jpg') }}" alt="">
                <div class="top-0 position-absolute start-0 w-100 h-100 d-flex align-items-center"
                    style="background: rgba(43, 57, 64, .5);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h1 class="mb-4 text-white display-3 animated slideInDown">Find The Best Startup Job
                                    That Fit You</h1>
                                <p class="pb-2 mb-4 text-white fs-5 fw-medium">Vero elitr justo clita lorem. Ipsum dolor
                                    at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea
                                    elitr.</p>
    ...
    <div class="py-5 container-xxl">
        <div class="container">
            <h1 class="mb-5 text-center wow fadeInUp" data-wow-delay="0.1s">Explore By Category</h1>
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a class="p-4 rounded cat-item" href="">
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <a class="p-4 rounded cat-item" href="">
                        <i class="mb-4 fa fa-3x fa-tasks text-primary"></i>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a class="p-4 rounded cat-item" href="">
                        <i class="mb-4 fa fa-3x fa-chart-line text-primary"></i>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a class="p-4 rounded cat-item" href="">
                        <i class="mb-4 fa fa-3x fa-hands-helping text-primary"></i>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <a class="p-4 rounded cat-item" href="">
                        <i class="mb-4 fa fa-3x fa-book-reader text-primary"></i>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <a class="p-4 rounded cat-item" href="">
                        <i class="mb-4 fa fa-3x fa-drafting-compass text-primary"></i>
        ...
        <div class="container">
            ...
            <div class="text-center tab-class wow fadeInUp" data-wow-delay="0.3s">
                <ul class="mb-5 nav nav-pills d-inline-flex justify-content-center border-bottom">
                    <li class="nav-item">
                        <a class="pb-3 mx-3 d-flex align-items-center text-start ms-0 active" data-bs-toggle="pill"
                            href="#tab-1">
                    ...
                    <div id="tab-1" class="p-0 tab-pane fade show active">
                        <div class="p-4 mb-4 job-item">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img class="flex-shrink-0 border rounded img-fluid"
                                        src="/static/img/com-logo-1.jpg" alt=""
                        ...
                        <div class="p-4 mb-4 job-item">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img class="flex-shrink-0 border rounded img-fluid"
                                        src="/static/img/com-logo-2.jpg" alt=""
                                        style="width: 80px; height: 80px;">
                                    <div class="text-start ps-4">
                        ...
                        <div class="p-4 mb-4 job-item">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img class="flex-shrink-0 border rounded img-fluid"
                                        src="/static/img/com-logo-3.jpg" alt=""
                                        style="width: 80px; height: 80px;">
                                    <div class="text-start ps-4">
                        ...
                        <div class="p-4 mb-4 job-item">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img class="flex-shrink-0 border rounded img-fluid"
                                        src="/static/img/com-logo-4.jpg" alt=""
                                        style="width: 80px; height: 80px;">
                                    <div class="text-start ps-4">
                        ...
                        <div class="p-4 mb-4 job-item">
                            <div class="row g-4">
                                <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                    <img class="flex-shrink-0 border rounded img-fluid"
                                        src="/static/img/com-logo-5.jpg" alt=""
                                        style="width: 80px; height: 80px;">
                                    <div class="text-start ps-4">
